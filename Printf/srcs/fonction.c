...
static void	get_length(const char *restrict format, t_data *data, int *i)
{
...
static void	get_precision(const char *restrict format, t_data *data, int *i)
{
	(*i)++;
...
static void	get_width(const char *restrict format, t_data *data, int *i)
{
...
static void	get_attributes(const char *restrict format, t_data *data, int *i)
{
	if (format[*i] == '#')
		data->sharp = 1;
	if (format[*i] == '0')
