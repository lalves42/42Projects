...
/*   Updated: 2015/12/21 19:12:48 by lalves           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!ft_strcmp(color, "LIGHT GREY") || !ft_strcmp(color, "light grey"))
		color = "37";
...
void		ft_putcolor(char *str, char *color)
{
	...
	if (!ft_strcmp(color, "CYAN") || !ft_strcmp(color, "cyan"))
		color = "36";
	if (!ft_strcmp(color, "DARK GREY") || !ft_strcmp(color, "dark grey"))
		color = "90";
